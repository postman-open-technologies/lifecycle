---
name: Change Visibility of a Workspace to Team
description: Change the visibility of a workspace and it's contents to be accessible only internally by teams.
links:
    - title: Link Title
