---
name: Share Collection with a Run in Postman Button
description: Share a collection by generating a Run in Postman button that can be embeeded on any site.
links:
    - title: Link Title
